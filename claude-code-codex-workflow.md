...
- **必须出现 Codex MCP 的调用**，才算成功。
- 由于 AI 的注意力机制，不一定会完全遵守 `CLAUDE.md`。
- 必要时可通过命令进行“唤醒”，确保真正触发 Codex MCP。

---

## 七、standard-workflow.md
